...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		echo $this->Html->script('codemirror/javascript');
		echo $this->Html->script('codemirror/xml');
		echo $this->Html->script('codemirror/css');
		echo $this->Html->script('codemirror/htmlmixed');
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				$("a#fullscreenButton").live("click", toggleFullscreen)
